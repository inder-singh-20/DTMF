...
cn=9; %order of filter
cr=0.5; % peak to peak passband ripples
cl=.25; % normalized passband frequency
ch=.28; % normalized passband frequency

[b,a]=cheby1(cn,cr,cl); % chebyshev type 1 filter
yfilt1=filter(b,a,y);
h2=fft(yfilt1,rmain);
hmag2=abs(h2(1:rmag));
